...
/// @title UpTBTC withdrawal phantom token
/// @notice Phantom ERC-20 token that represents the balance of the pending and claimable withdrawals in UpTBTC vaults
contract UpTBTCWithdrawalPhantomToken is PhantomERC20, IPhantomToken {
    bytes32 public constant override contractType = "PHANTOM_TOKEN::UPTBTC_WITHDRAWAL";
    ...
    constructor(address _vault, address _gateway)
        PhantomERC20(
            ...
            string.concat("UpTBTC withdrawn ", IERC20Metadata(IERC4626(_vault).asset()).name()),
    ...
    function balanceOf(address account) public view returns (uint256) {
        return IUpTBTCGateway(gateway).pendingAssetsOf(account);
    }
