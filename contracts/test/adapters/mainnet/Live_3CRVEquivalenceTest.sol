...
import { ICurveV1_3AssetsAdapter } from "../../../interfaces/adapters/curve/ICurveV1_3AssetsAdapter.sol";
...
contract Live_3CRVEquivalenceTest is DSTest, LiveEnvHelper {
    ...
    function compareExtraFunctions(
        ...
        if (isAdapter) {
            ICurveV1_3AssetsAdapter pool = ICurveV1_3AssetsAdapter(curvePoolAddr);
    ...
    function test_live_CRVET_01_3CRV_adapter_and_normal_account_works_identically()
        public
        liveOnly
    {
