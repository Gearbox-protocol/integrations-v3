...
import { ICreditManagerV2, ICreditManagerV2Events, ClosureAction } from "@gearbox-protocol/core-v2/contracts/interfaces/ICreditManagerV2.sol";
import { ICreditFacadeEvents, ICreditFacadeExceptions } from "@gearbox-protocol/core-v2/contracts/interfaces/ICreditFacade.sol";
...
import { CreditFacadeMulticaller, CreditFacadeCalls } from "@gearbox-protocol/core-v2/contracts/multicall/CreditFacadeCalls.sol";
    ...
    ICreditFacadeExceptions
{
    ...
    function test_FA_03EaddCollateral_correctly_wraps_ETH() public {
        _openTestCreditAccount();
    ...
    function test_FA_21addCollateral_executes_actions_as_expected() public {
        (address creditAccount, ) = _openTestCreditAccount();
    ...
    function test_FA_21AaddCollateral_reverts_on_account_transfer_not_allowed()
        public
    {
        _openTestCreditAccount();
    ...
    function test_FA_21BaddCollateral_reverts_on_account_transfer_not_allowed_multicall()
        public
    {
        _openTestCreditAccount();
    ...
    function test_FA_21CaddCollateral_optimizes_enabled_tokens() public {
        (address creditAccount, ) = _openTestCreditAccount();
    ...
    function test_FA_26_multicalladdCollateral_and_increase_debt_works_with_creditFacade_calls_as_expected()
        public
    {
        (address creditAccount, ) = _openTestCreditAccount();
    ...
    function test_FA_27_multicalladdCollateral_and_decreaseDebt_works_with_creditFacade_calls_as_expected()
        public
    {
        (address creditAccount, ) = _openTestCreditAccount();
