...
contract CreditConfigLive {
    ...
    constructor() {
        ...
        cm = creditManagerHumanOpts[Tokens.DAI];cm.minBorrowedAmount = 150000000000000000000000;cm.maxBorrowedAmount = 1000000000000000000000000;cm.degenNFT = address(0);cm.expirable = false;cm.collateralTokens.push(CollateralTokenHuman({
    token: Tokens.WETH,
    liquidationThreshold: 8500
  }));
cm.collateralTokens.push(CollateralTokenHuman({
    token: Tokens.STETH,
...
cm.contracts.push(Contracts.UNIVERSAL_ADAPTER);cm = creditManagerHumanOpts[Tokens.USDC];cm.minBorrowedAmount = 150000000000;cm.maxBorrowedAmount = 1000000000000;cm.degenNFT = address(0);cm.expirable = false;cm.collateralTokens.push(CollateralTokenHuman({
    token: Tokens.WETH,
    liquidationThreshold: 8500
  }));
cm.collateralTokens.push(CollateralTokenHuman({
...
cm.contracts.push(Contracts.CONVEX_BOOSTER);
cm.contracts.push(Contracts.CONVEX_CLAIM_ZAP);
cm.contracts.push(Contracts.UNIVERSAL_ADAPTER);cm = creditManagerHumanOpts[Tokens.WETH];cm.minBorrowedAmount = 100000000000000000000;cm.maxBorrowedAmount = 600000000000000000000;cm.degenNFT = address(0);cm.expirable = false;cm.collateralTokens.push(CollateralTokenHuman({
    token: Tokens.STETH,
    liquidationThreshold: 9000
  }));
cm.collateralTokens.push(CollateralTokenHuman({
...
cm.contracts.push(Contracts.CONVEX_BOOSTER);
cm.contracts.push(Contracts.CONVEX_CLAIM_ZAP);
cm.contracts.push(Contracts.UNIVERSAL_ADAPTER);cm = creditManagerHumanOpts[Tokens.wstETH];cm.minBorrowedAmount = 100000000000000000000;cm.maxBorrowedAmount = 600000000000000000000;cm.degenNFT = address(0);cm.expirable = false;cm.collateralTokens.push(CollateralTokenHuman({
    token: Tokens.STETH,
...
cm.contracts.push(Contracts.LIDO_WSTETH);cm = creditManagerHumanOpts[Tokens.WBTC];cm.minBorrowedAmount = 750000000;cm.maxBorrowedAmount = 5000000000;cm.degenNFT = address(0);cm.expirable = false;cm.collateralTokens.push(CollateralTokenHuman({
    token: Tokens.WETH,
    liquidationThreshold: 8500
  }));
cm.collateralTokens.push(CollateralTokenHuman({
