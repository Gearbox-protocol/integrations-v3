...
contract SupportedContracts is ISupportedContracts {
    ...
    constructor(uint8 networkId) {
        ...
        if (networkId == 1) {
            ...
            cd[12] = ContractData({
                id: Contracts.CURVE_OHM_FRAXBP,
                addr: 0xFc1e8bf3E81383Ef07Be24c3FD146745719DE48D,
                name: "CURVE_OHM_FRAXBP"
            });
            cd[13] = ContractData({
            ...
            cd[11] = ContractData({id: Contracts.CURVE_GEAR_POOL, addr: address(0), name: "CURVE_GEAR_POOL"});
            cd[12] = ContractData({id: Contracts.CURVE_OHM_FRAXBP, addr: address(0), name: "CURVE_OHM_FRAXBP"});
            cd[13] = ContractData({
                id: Contracts.YEARN_DAI_VAULT,
            ...
            cd[31] = ContractData({id: Contracts.BALANCER_VAULT, addr: address(0), name: "BALANCER_VAULT"});
        }
