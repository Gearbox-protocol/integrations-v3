...
contract TokensDataLive {
    ...
    constructor(uint8 networkId) {
        ...
        td[28] = TokenData({id: Tokens.GMX, addr: address(0), symbol: "GMX", tokenType: TokenType.NORMAL_TOKEN});
        td[29] = TokenData({
            id: Tokens.ARB,
        ...
        td[30] = TokenData({id: Tokens.RDNT, addr: address(0), symbol: "RDNT", tokenType: TokenType.NORMAL_TOKEN});
        td[31] = TokenData({
            id: Tokens.BAL,
