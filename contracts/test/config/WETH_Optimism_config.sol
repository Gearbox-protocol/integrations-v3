...
contract CONFIG_OPTIMISM_WETH_V3 is IPoolV3DeployConfig {
    ...
    uint256 public constant getAccountAmount = 5_000_000_000_000_000_000;
    ...
    constructor() {
        ...
        _quotaLimits.push(PoolQuotaLimit({token: Tokens.WBTC, quotaIncreaseFee: 1, limit: 300_000_000_000_000_000_000}));
        _quotaLimits.push(
            PoolQuotaLimit({token: Tokens.USDC, quotaIncreaseFee: 1, limit: 1_500_000_000_000_000_000_000})
        );
        _quotaLimits.push(PoolQuotaLimit({token: Tokens.OP, quotaIncreaseFee: 1, limit: 900_000_000_000_000_000_000}));
        _quotaLimits.push(PoolQuotaLimit({token: Tokens.WLD, quotaIncreaseFee: 5, limit: 50_000_000_000_000_000_000}));
        _quotaLimits.push(PoolQuotaLimit({token: Tokens.LINK, quotaIncreaseFee: 5, limit: 25_000_000_000_000_000_000}));
        _quotaLimits.push(PoolQuotaLimit({token: Tokens.SNX, quotaIncreaseFee: 5, limit: 500_000_000_000_000_000_000}));
        _quotaLimits.push(PoolQuotaLimit({token: Tokens.yvOP, quotaIncreaseFee: 1, limit: 275_000_000_000_000_000_000}));
        _quotaLimits.push(
            PoolQuotaLimit({token: Tokens.yvUSDC, quotaIncreaseFee: 0, limit: 165_000_000_000_000_000_000})
        );
        _quotaLimits.push(
            PoolQuotaLimit({token: Tokens.yvWETH, quotaIncreaseFee: 1, limit: 200_000_000_000_000_000_000})
        );
        _quotaLimits.push(
            PoolQuotaLimit({token: Tokens.wstETH, quotaIncreaseFee: 1, limit: 1_500_000_000_000_000_000_000})
        );
        _quotaLimits.push(
            PoolQuotaLimit({token: Tokens.rETH, quotaIncreaseFee: 1, limit: 1_500_000_000_000_000_000_000})
        );

        {
            ...
            cp.minDebt = 500_000_000_000_000_000;
            ...
            cts.push(CollateralTokenHuman({token: Tokens.yvUSDC, lt: 94_00}));
        ...
        }
        {
            ...
            cp.minDebt = 500_000_000_000_000_000;
            cp.maxDebt = 25_000_000_000_000_000_000;
            cp.feeInterest = 2500;
            ...
            cp.expirable = false;
            cp.skipInit = false;
            cp.poolLimit = 250_000_000_000_000_000_000;

            CollateralTokenHuman[] storage cts = cp.collateralTokens;
            cts.push(CollateralTokenHuman({token: Tokens.USDC, lt: 95_00}));
        ...
        }
        {
            ...
            cp.maxDebt = 50_000_000_000_000_000_000;
            cp.feeInterest = 2500;
            cp.feeLiquidation = 50;
            cp.liquidationPremium = 100;
            cp.feeLiquidationExpired = 50;
            ...
            cts.push(CollateralTokenHuman({token: Tokens.yvWETH, lt: 96_00}));
            Contracts[] storage cs = cp.contracts;
            cs.push(Contracts.UNISWAP_V3_ROUTER);
            UniswapV3Pair[] storage uv3p = cp.uniswapV3Pairs;
            uv3p.push(UniswapV3Pair({token0: Tokens.WETH, token1: Tokens.wstETH, fee: 100}));
            uv3p.push(UniswapV3Pair({token0: Tokens.WETH, token1: Tokens.rETH, fee: 100}));
            cs.push(Contracts.BALANCER_VAULT);
            BalancerPool[] storage bp = cp.balancerPools;
