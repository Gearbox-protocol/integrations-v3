...
contract CompoundV2_CErc20Adapter_Test is CompoundTestHelper {
    ...
    function setUp() public {
        ...
        adapter = new CompoundV2_CErc20Adapter(address(CreditManagerV3), cusdc);
        CreditConfiguratorV3.allowContract(cusdc, address(adapter));
    ...
    function test_ACV2CERC_01_constructor_reverts_on_not_registered_tokens() public {
        ...
        new CompoundV2_CErc20Adapter(address(CreditManagerV3), cdai);
    }
    ...
    function test_ACV2CERC_02_constructor_sets_correct_values() public {
        ...
        assertEq(adapter.cTokenMask(), CreditManagerV3.tokenMasksMap(cusdc), "Incorrect cUSDC mask");
    }
}
