...
import {
    ...
    Version,
    IERC20
} from "../../../../integrations/traderjoe/interfaces/external/ITraderJoeRouter.sol";
import {
    ITraderJoeRouterAdapter,
    TraderJoePoolStatus,
    TraderJoePool
} from "../../../../integrations/traderjoe/interfaces/ITraderJoeRouterAdapter.sol";
    ...
    function test_U_TJ_04_swapExactTokensForTokensSupportingFeeOnTransferTokens_works_as_expected() public {
        ...
        _executesSwap({
            ...
            callData: abi.encodeCall(
                ...
                (123, 456, path, creditAccount, 789)
            ),
            requiresApproval: true
        });
