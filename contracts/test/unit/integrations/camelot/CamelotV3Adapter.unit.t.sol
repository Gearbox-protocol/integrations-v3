...
contract CamelotV3AdapterUnitTest is AdapterUnitTestHelper, ICamelotV3AdapterTypes {
    ...
    function test_U_CAMV3_05_exactInput_works_as_expected() public {
        ...
        _readsActiveAccount();
        _executesSwap({
            tokenIn: tokens[0], callData: abi.encodeCall(ICamelotV3Router.exactInput, (params)), requiresApproval: true
        });
    ...
    function test_U_CAMV3_08_exactOutput_works_as_expected() public {
        ...
        _readsActiveAccount();
        _executesSwap({
            tokenIn: tokens[2], callData: abi.encodeCall(ICamelotV3Router.exactOutput, (params)), requiresApproval: true
        });
