...
import {IBalancerV3Router} from "../../../../integrations/balancer/interfaces/external/IBalancerV3Router.sol";
import {IBalancerV3Pool} from "../../../../integrations/balancer/interfaces/external/IBalancerV3Pool.sol";
import {
    ...
    PoolStatus
} from "../../../../integrations/balancer/interfaces/IBalancerV3RouterAdapter.sol";
import {BalancerV3RouterAdapter} from "../../../../integrations/balancer/BalancerV3RouterAdapter.sol";
    ...
    function test_U_BAL3_07_removeLiquiditySingleTokenExactIn_works_as_expected() public {
        ...
        _executesSwap({
            ...
            callData: abi.encodeCall(
                ...
                (balancerPool, 100, IERC20(tokens[0]), 50, false, "")
            ),
            requiresApproval: true
        });
