...
import {BalancerV3WrapperAdapter} from "../../../../integrations/balancer/BalancerV3WrapperAdapter.sol";
import {IBalancerV3Wrapper} from "../../../../integrations/balancer/interfaces/external/IBalancerV3Wrapper.sol";
...
contract BalancerV3WrapperAdapterUnitTest is AdapterUnitTestHelper {
    ...
    function test_U_BV3W_05_burn_works_as_expected() public {
        _executesSwap({
            tokenIn: wrapper, callData: abi.encodeCall(IBalancerV3Wrapper.burn, (1000)), requiresApproval: false
        });
        vm.prank(creditFacade);
