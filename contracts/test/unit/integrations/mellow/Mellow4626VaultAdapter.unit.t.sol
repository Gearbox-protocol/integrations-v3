...
import {Mellow4626VaultAdapter} from "../../../../integrations/mellow/Mellow4626VaultAdapter.sol";
import {IMellowMultiVault} from "../../../../integrations/mellow/interfaces/external/IMellowMultiVault.sol";
import {IMellow4626VaultAdapter} from "../../../../integrations/mellow/interfaces/IMellow4626VaultAdapter.sol";
import {MellowWithdrawalPhantomToken} from "../../../../integrations/mellow/MellowWithdrawalPhantomToken.sol";
...
contract Mellow4626VaultAdapterUnitTest is AdapterUnitTestHelper {
    ...
    function test_U_M4626_04_deposit_works_as_expected() public {
        ...
        _readsActiveAccount();
        _executesSwap({
            tokenIn: asset, callData: abi.encodeCall(IERC4626.deposit, (1000, creditAccount)), requiresApproval: true
        });
    ...
    function test_U_M4626_06_mint_works_as_expected() public {
        ...
        _readsActiveAccount();
        _executesSwap({
            tokenIn: asset, callData: abi.encodeCall(IERC4626.mint, (1000, creditAccount)), requiresApproval: true
        });
        vm.prank(creditFacade);
