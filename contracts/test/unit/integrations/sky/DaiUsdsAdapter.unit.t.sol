...
contract DaiUsdsAdapterUnitTest is AdapterUnitTestHelper {
    ...
    function test_U_DUSDS_03_daiToUsds_works_as_expected() public {
        ...
        _readsActiveAccount();
        _executesSwap({
            tokenIn: dai, callData: abi.encodeCall(IDaiUsds.daiToUsds, (creditAccount, amount)), requiresApproval: true
        });
    ...
    function test_U_DUSDS_05_usdsToDai_works_as_expected() public {
        ...
        _readsActiveAccount();
        _executesSwap({
            tokenIn: usds, callData: abi.encodeCall(IDaiUsds.usdsToDai, (creditAccount, amount)), requiresApproval: true
        });
        vm.prank(creditFacade);
