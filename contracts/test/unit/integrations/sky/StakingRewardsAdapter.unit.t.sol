...
import {IStakingRewardsReferral} from "../../../../integrations/sky/interfaces/external/IStakingRewards.sol";
...
contract StakingRewardsAdapterUnitTest is AdapterUnitTestHelper {
    ...
    function test_U_SR_03_stake_works_as_expected() public {
        _executesSwap({
            tokenIn: stakingToken, callData: abi.encodeCall(IStakingRewards.stake, (1000)), requiresApproval: true
        });
