...
import {FluidDexAdapter} from "../../../../integrations/fluid/FluidDexAdapter.sol";
import {IFluidDex, ConstantViews} from "../../../../integrations/fluid/interfaces/external/IFluidDex.sol";
    ...
    function test_U_FDEX_05_swapInDiff_works_as_expected_0to1() public diffTestCases {
        ...
        _executesSwap({
            ...
            callData: abi.encodeCall(
                IFluidDex.swapIn, (swap0to1, diffInputAmount, expectedAmountOutMin, creditAccount)
            ),
            requiresApproval: true
        });
        vm.prank(creditFacade);
