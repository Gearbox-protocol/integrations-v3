...
import {IwstETH, IwstETHGetters} from "../../../../integrations/lido/interfaces/external/IwstETH.sol";
...
contract WstETHV1AdapterUnitTest is AdapterUnitTestHelper {
    ...
    function test_U_LDO1W_04_wrapDiff_works_as_expected() public diffTestCases {
        ...
        _readsActiveAccount();
        _executesSwap({
            tokenIn: stETH, callData: abi.encodeCall(IwstETH.wrap, (diffInputAmount)), requiresApproval: true
        });
        vm.prank(creditFacade);
    ...
    function test_U_LDO1W_06_unwrapDiff_works_as_expected() public diffTestCases {
        ...
        _readsActiveAccount();
        _executesSwap({
            tokenIn: wstETH, callData: abi.encodeCall(IwstETH.unwrap, (diffInputAmount)), requiresApproval: false
        });
        vm.prank(creditFacade);
