...
import {IUpshiftVaultGateway} from "../../../../integrations/upshift/interfaces/IUpshiftVaultGateway.sol";
...
contract UpshiftVaultAdapterUnitTest is AdapterUnitTestHelper {
    ...
    function test_U_UV_04_requestRedeem_works_as_expected() public {
        _executesSwap({
            tokenIn: vault, callData: abi.encodeCall(IUpshiftVaultGateway.requestRedeem, (1000)), requiresApproval: true
        });
    ...
    function test_U_UV_05_claim_works_as_expected() public {
        _executesSwap({
            tokenIn: address(0), callData: abi.encodeCall(IUpshiftVaultGateway.claim, (1000)), requiresApproval: false
        });
