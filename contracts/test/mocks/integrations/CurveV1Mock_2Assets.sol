...
contract CurveV1Mock_2Assets is CurveV1Mock, ICurvePool2Assets {
    using SafeERC20 for IERC20;

    constructor(address[] memory _coins, address[] memory _underlying_coins)
        CurveV1Mock(_coins, _underlying_coins)
    {}
