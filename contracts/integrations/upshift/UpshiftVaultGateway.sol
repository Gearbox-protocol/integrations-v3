...
import {IUpshiftVault} from "./interfaces/external/IUpshiftVault.sol";
import {IUpshiftVaultGateway} from "./interfaces/IUpshiftVaultGateway.sol";
...
contract UpshiftVaultGateway is ReentrancyGuardTrait, IUpshiftVaultGateway {
    ...
    function requestRedeem(uint256 shares) external nonReentrant {
        ...
        (uint256 assets, uint256 claimableTimestamp) = IUpshiftVault(upshiftVault)
            .requestRedeem({shares: shares, receiverAddr: address(this), holderAddr: msg.sender});
    ...
    function claim(uint256 amount) external nonReentrant {
        ...
        uint256 totalClaimableAssets = IUpshiftVault(upshiftVault)
            .getClaimableAmountByReceiver(pendingRedeem.year, pendingRedeem.month, pendingRedeem.day, address(this));
