...
import {ITreehouseTransferMaster} from "./ITreehouseTransferMaster.sol";

/// @title Treehouse liquidator interface
/// @notice Liquidation entry point that unlocks redeemer transfers for the duration of the liquidation
interface ITreehouseLiquidator is ITreehouseTransferMaster {
