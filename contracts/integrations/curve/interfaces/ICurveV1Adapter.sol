...
interface ICurveV1Adapter is IAdapter {
    ...
    function exchange_underlying(uint256 i, uint256 j, uint256 dx, uint256 min_dy) external returns (bool useSafePrices);

    function exchange_underlying(int128 i, int128 j, uint256 dx, uint256 min_dy) external returns (bool useSafePrices);
    ...
    function add_liquidity_one_coin(uint256 amount, uint256 i, uint256 minAmount) external returns (bool useSafePrices);
