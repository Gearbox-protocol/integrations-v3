...
import {ICurvePoolStableNG} from "./interfaces/external/ICurvePool_StableNG.sol";
import {ICurveV1_StableNGAdapter} from "./interfaces/ICurveV1_StableNGAdapter.sol";
...
contract CurveV1AdapterStableNG is CurveV1AdapterBase, ICurveV1_StableNGAdapter {
    ...
    constructor(address _creditManager, address _curvePool, address _lp_token, address _metapoolBase, bool _use256)
        CurveV1AdapterBase(
            _creditManager, _curvePool, _lp_token, _metapoolBase, ICurvePoolStableNG(_curvePool).N_COINS(), _use256
        )
    {}
