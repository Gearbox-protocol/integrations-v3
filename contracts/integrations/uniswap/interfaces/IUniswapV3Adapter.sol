...
import {ISwapRouter} from "./external/IUniswapV3.sol";
...
interface IUniswapV3Adapter is IAdapter, IUniswapV3AdapterTypes {
    ...
    function exactInputSingle(ISwapRouter.ExactInputSingleParams calldata params) external returns (bool useSafePrices);
