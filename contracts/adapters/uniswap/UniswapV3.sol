    ...
    IUniswapV3Adapter
{
    ...
    function exactAllInputSingle(
        ...
        if (balanceInBefore > 1) {
            ...
            ISwapRouter.ExactInputSingleParams memory paramsUpdate = ISwapRouter
    ...
    function exactAllInput(
        ExactAllInputParams calldata params
    ) external override creditFacadeOnly {
        address creditAccount = _creditAccount(); // F:[AUV3-1]
        ...
        if (balanceInBefore > 1) {
            ...
            ISwapRouter.ExactInputParams memory paramsUpdate = ISwapRouter
                .ExactInputParams({
                    path: params.path,
                    recipient: creditAccount,
                    deadline: params.deadline,
    ...
    function exactOutput(
        ...
        _executeSwapMaxApprove(
            ...
            tokenIn,
            tokenOut,
            abi.encodeCall(ISwapRouter.exactOutput, (paramsUpdate)),
            false
        ); // F:[AUV3-7]
    }
