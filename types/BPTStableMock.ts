...
export interface BPTStableMockInterface extends utils.Interface {
  functions: {
...
export interface BPTStableMock extends BaseContract {
  contractName: "BPTStableMock";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BPTStableMockInterface;
