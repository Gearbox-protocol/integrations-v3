...
export interface WstETHV1MockInterface extends utils.Interface {
  functions: {
    ...
    "setStEthPerToken(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setStEthPerToken",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
...
export interface WstETHV1Mock extends BaseContract {
  contractName: "WstETHV1Mock";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WstETHV1MockInterface;
