...
export interface CurveV1Mock_2AssetsInterface extends utils.Interface {
  functions: {
    "A()": FunctionFragment;
...
export interface CurveV1Mock_2Assets extends BaseContract {
  contractName: "CurveV1Mock_2Assets";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CurveV1Mock_2AssetsInterface;
