...
export interface AdapterDeployerInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "IS_TEST" | "adapters" | "failed" | "getAdapters"
  ): FunctionFragment;
...
export interface AdapterDeployer extends BaseContract {
  contractName: "AdapterDeployer";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AdapterDeployerInterface;
  ...
  functions: {
    ...
    getAdapters(overrides?: CallOverrides): Promise<[AdapterStructOutput[]]>;
  };
