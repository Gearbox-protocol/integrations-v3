...
export interface CompoundTestHelperInterface extends utils.Interface {
  functions: {
...
export interface CompoundTestHelper extends BaseContract {
  contractName: "CompoundTestHelper";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CompoundTestHelperInterface;
