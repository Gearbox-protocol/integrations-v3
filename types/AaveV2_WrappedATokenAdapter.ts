...
export interface AaveV2_WrappedATokenAdapterInterface extends utils.Interface {
  functions: {
...
export interface AaveV2_WrappedATokenAdapter extends BaseContract {
  contractName: "AaveV2_WrappedATokenAdapter";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AaveV2_WrappedATokenAdapterInterface;
