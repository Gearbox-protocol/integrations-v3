...
export interface CompoundV2_CTokenAdapterInterface extends utils.Interface {
  functions: {
...
export interface CompoundV2_CTokenAdapter extends BaseContract {
  contractName: "CompoundV2_CTokenAdapter";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CompoundV2_CTokenAdapterInterface;
