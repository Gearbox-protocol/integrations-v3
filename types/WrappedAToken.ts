...
export interface WrappedATokenInterface extends utils.Interface {
  functions: {
...
export interface WrappedAToken extends BaseContract {
  contractName: "WrappedAToken";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WrappedATokenInterface;
