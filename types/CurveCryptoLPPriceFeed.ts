...
export interface CurveCryptoLPPriceFeedInterface extends utils.Interface {
  functions: {
...
export interface CurveCryptoLPPriceFeed extends BaseContract {
  ...
  interface: CurveCryptoLPPriceFeedInterface;
  ...
  functions: {
    ...
    nCoins(overrides?: CallOverrides): Promise<[number]>;
