...
export interface TokensTestSuiteInterface extends utils.Interface {
  functions: {
    ...
    "approveMany(uint8[],address,address)": FunctionFragment;
...
export interface TokensTestSuite extends BaseContract {
  ...
  functions: {
    ...
    approveMany(
      tokensToApprove: PromiseOrValue<BigNumberish>[],
      holder: PromiseOrValue<string>,
    ...
    mockTokens(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    mockTokens(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    mockTokens(overrides?: CallOverrides): Promise<PopulatedTransaction>;
