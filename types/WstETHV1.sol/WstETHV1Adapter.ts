...
export interface WstETHV1AdapterInterface extends utils.Interface {
  functions: {
...
export interface WstETHV1Adapter extends BaseContract {
  contractName: "WstETHV1Adapter";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WstETHV1AdapterInterface;
