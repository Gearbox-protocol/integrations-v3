...
export interface CompoundV2_CErc20AdapterInterface extends utils.Interface {
  functions: {
...
export interface CompoundV2_CErc20Adapter extends BaseContract {
  contractName: "CompoundV2_CErc20Adapter";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CompoundV2_CErc20AdapterInterface;
