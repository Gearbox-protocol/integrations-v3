...
export interface CurveV1AdapterHelperInterface extends utils.Interface {
  functions: {
...
export interface CurveV1AdapterHelper extends BaseContract {
  contractName: "CurveV1AdapterHelper";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CurveV1AdapterHelperInterface;
