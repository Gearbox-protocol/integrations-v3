...
export interface AaveTestHelperInterface extends utils.Interface {
  functions: {
...
export interface AaveTestHelper extends BaseContract {
  contractName: "AaveTestHelper";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AaveTestHelperInterface;
