...
export interface AbstractCurveLPPriceFeedInterface extends utils.Interface {
  functions: {
...
export interface AbstractCurveLPPriceFeed extends BaseContract {
  contractName: "AbstractCurveLPPriceFeed";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AbstractCurveLPPriceFeedInterface;
