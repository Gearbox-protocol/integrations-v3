...
export interface CurveLP3PriceFeedInterface extends utils.Interface {
  functions: {
...
export interface CurveLP3PriceFeed extends BaseContract {
  contractName: "CurveLP3PriceFeed";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CurveLP3PriceFeedInterface;
