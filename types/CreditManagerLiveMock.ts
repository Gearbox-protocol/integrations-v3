...
export interface CreditManagerLiveMockInterface extends utils.Interface {
  functions: {
...
export interface CreditManagerLiveMock extends BaseContract {
  contractName: "CreditManagerLiveMock";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CreditManagerLiveMockInterface;
