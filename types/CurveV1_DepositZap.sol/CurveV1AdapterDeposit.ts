...
export interface CurveV1AdapterDepositInterface extends utils.Interface {
  functions: {
...
export interface CurveV1AdapterDeposit extends BaseContract {
  contractName: "CurveV1AdapterDeposit";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CurveV1AdapterDepositInterface;
