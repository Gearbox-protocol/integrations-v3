...
export interface CurveLP4PriceFeedInterface extends utils.Interface {
  functions: {
...
export interface CurveLP4PriceFeed extends BaseContract {
  contractName: "CurveLP4PriceFeed";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CurveLP4PriceFeedInterface;
