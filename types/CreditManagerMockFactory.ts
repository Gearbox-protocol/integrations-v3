...
export interface CreditManagerMockFactoryInterface extends utils.Interface {
  functions: {
...
export interface CreditManagerMockFactory extends BaseContract {
  contractName: "CreditManagerMockFactory";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CreditManagerMockFactoryInterface;
