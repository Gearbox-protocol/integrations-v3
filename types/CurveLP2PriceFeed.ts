...
export interface CurveLP2PriceFeedInterface extends utils.Interface {
  functions: {
...
export interface CurveLP2PriceFeed extends BaseContract {
  contractName: "CurveLP2PriceFeed";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CurveLP2PriceFeedInterface;
